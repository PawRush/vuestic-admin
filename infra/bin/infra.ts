...
// When deploying pipeline, use pipeline configuration
if (codeConnectionArn) {
  ...
  // When deploying frontend directly, use environment-based configuration
  ...
  new FrontendStack(app, `VuesticAdminFrontend-${environment}`, {
    env: { account, region },
    environment,
    buildOutputPath,
