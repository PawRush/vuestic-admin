...
export class FrontendStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: FrontendStackProps) {
    ...
    // Create CloudFront distribution with S3 bucket
    const cloudfrontToS3 = new CloudFrontToS3(this, "CFToS3", {
      ...
      // The below are required to support client-side features like 'unsafe-eval' and 'unsafe-inline'
      // that are used by fonts, Google Analytics, etc.
      ...
      cloudFrontDistributionProps: {
        ...
        // SPA configuration: redirect 403/404 errors to index.html for client-side routing
        errorResponses: [
          {
            httpStatus: 403,
